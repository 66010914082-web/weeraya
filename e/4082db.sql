...
-- Database: `4082db`
--
CREATE DATABASE IF NOT EXISTS `4082db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `4082db`;
...
(1, 'Data Analyst', 'นาย', 'วีรญา เลาต๋า', '2025-12-17', 'ปริญญาตรี', '{skills}', '{experience}');
...
(1, 'วีรญา เลาต๋า', '111111111', 170, '#6f1111', 'การตลาด');
